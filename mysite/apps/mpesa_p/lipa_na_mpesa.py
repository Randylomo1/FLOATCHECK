...
def get_mpesa_access_token():
    ...
    try:
        r = requests.get(api_URL, auth=HTTPBasicAuth(consumer_key, consumer_secret), params=params)
...
def lipa_na_mpesa(phone_number, amount):
    ...
    payload = {
        ...
        "CallBackURL": "https://e2e18a58c990.ngrok-free.app/mpesa/mpesa_callback/",
    ...
    try:
        ...
        try:
            ...
            error_message = error_response.get('errorMessage', 'An unknown error occurred.')
        except json.JSONDecodeError:
            error_message = e.response.text
        return None, f"Error: {e.response.status_code} {e.response.reason}. Details: {error_message}"
    except requests.exceptions.RequestException as e:
        return None, str(e)
